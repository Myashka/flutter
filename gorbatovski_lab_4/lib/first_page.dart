...
import 'package:gorbatovski_lab_3/bloc/cat_http_event.dart';
...
class MyHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("HTTP cat status code")),
      body: Center(
        child: Container(
              ...
              ElevatedButton(
                onPressed: () {
                  if (_controller.text.isEmpty || !isURL(_controller.text)) {
                    ...
                    context.read<CatHttpBloc>().add(LoadEvent(inputUrl: url));
